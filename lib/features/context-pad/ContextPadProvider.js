...
ContextPadProvider.prototype.getContextPadEntries = function (element) {
  ...
  // TODO: this is a bit of a hack, we should come up with a better way to
  // share this logic between append and connect actions
  ...
  function appendAction(type, className, title, options = {}) {
    ...
    // Solution for #2370: Add the hover handler
    const previewAppend = (event, element) => {
      if (!appendPreview) {
        return;
      }
    ...
    return {
      ...
      action: {
        ...
        click: appendStart,
        hover: previewAppend // <--- Crucial for Issue #2370
      }
    };
  }
